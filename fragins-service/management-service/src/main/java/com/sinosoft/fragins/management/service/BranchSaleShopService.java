...
public class BranchSaleShopService {
    ...
    public String excute() throws Exception{
        try{
            // 1.读取部门采销店铺excel信息
            List<BranchSaleShopData> branchDataList = this.readBranchExcel();
...
//            saleDataDao.insertBatch(saleDataAgainList);
    ...
    public void caculateData(String name, String date){
        ...
        for (int i = 0; i < scendList.size(); i++) {
            ...
            if ("站内新".equals(data.getDataType())){
    ...
    public List<BranchSaleShopData> readBranchExcel() throws Exception{
        List<String> list = ReadExcelYsx.readExcel("D:\\workspace\\workspaceMyself\\部门采销店铺.xlsx");
