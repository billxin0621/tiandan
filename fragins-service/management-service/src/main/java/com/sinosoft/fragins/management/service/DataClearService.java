...
//        String dateLastMonth = localDateLastMonth.format(dateTimeFormatter);//今年上月
        ...
        this.caculate(branch, date);
        // 4.跨境母婴自营组2022-03 数据
        branch = "跨境母婴自营组";
        this.caculate(branch, dateLastMonth);
        // 5.跨境母婴自营组2021-04 数据
        branch = "跨境母婴自营组";
        this.caculate(branch, dateLastYear);
        ...
        branch = "跨境母婴自营组";
        String dataType = "总用户";
        this.caculateResult(branch, dataType);
        // 10.跨境母婴自营组 老用户 数据
        branch = "跨境母婴自营组";
        dataType = "老用户";
        this.caculateResult(branch, dataType);
    ...
    public void caculate(String branch, String date){
